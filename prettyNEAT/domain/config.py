...
# -- Pivector envs (Pendulum, CartPole, AcroBot, LunarLander) ------------ -- #
# The parameters here are copy/paste of CartPoleSwingUp Above
pendulum = Game(env_name='Pendulum-v0',
  actionSelect='all', # all, soft, hard
  input_size=3,
  output_size=1,
  time_factor=0,
  ...
  output_noise=[False, False, False],
  max_episode_length = 200,
  in_out_labels = ['input1','input2','input3','output1']
)
games['pendulum'] = pendulum
...
cartpole = Game(env_name='CartPole-v1',
  ...
  output_noise=[False, False, False],
  max_episode_length = 500,
  in_out_labels = ['input1','input2','input3','input4','output1','output2']
)
games['cartpole'] = cartpole

acrobot = Game(env_name='Acrobot-v1',
  actionSelect='prob', # all, soft, hard
  input_size=6,
  output_size=3,
  time_factor=0,
  ...
  output_noise=[False, False, False],
  max_episode_length = 500,
  in_out_labels = ['input1','input2','input3','input4','input5','input6','output1','output2','output3']
)
games['acrobot'] = acrobot
